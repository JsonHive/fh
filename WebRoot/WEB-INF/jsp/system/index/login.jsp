			...
			<form action="" method="post" name="loginForm"
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<span class="pull-right"><a onclick="serverCheck();" class="flip-link btn btn-info" id="to-recover">登录</a></span>
					</div>
				</div>
			</form>
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © JH 2016</span></font>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function serverCheck(){
			if(check()){
				...
				var code = loginname+",JH,"+password+",JH,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
