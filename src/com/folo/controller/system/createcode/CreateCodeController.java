package com.folo.controller.system.createcode;
...
import com.folo.service.system.createcode.CreateCodeManager;
import com.folo.util.AppUtil;
import com.folo.util.DateUtil;
import com.folo.util.DelAllFile;
import com.folo.util.FileDownload;
import com.folo.util.FileZip;
import com.folo.util.Freemarker;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		for(int i=0; i< zindex; i++){
			fieldList.add(pd.getString("field"+i).split(",folo,"));	//属性放到集合里面
		}
	...
	public void save(PageData pd) throws Exception{
		...
		pd.put("TABLENAME", pd.getString("tabletop")+",folo,"+pd.getString("objectName").toUpperCase());	//表名
